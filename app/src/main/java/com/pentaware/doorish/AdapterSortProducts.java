...
public class AdapterSortProducts extends RecyclerView.Adapter<AdapterSortProducts.ViewHolder> {
    ...
    public AdapterSortProducts(List<String> sortProductList, Context context, ISortFilterOperations iSortFilterOperations ) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sort_product_list, parent, false);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    int pos = getAdapterPosition();
                        ...
                        iSortFilterOperations.onSortSelected(sortProductList.get(pos));
